...
for i in range(95):
    ...
    heat6 = str(a.getData(i, 1, "6天前"))
    heat5 = str(a.getData(i, 1, "5天前"))
    heat4 = str(a.getData(i, 1, "4天前"))
    heat3 = str(a.getData(i, 1, "3天前"))
    heat2 = str(a.getData(i, 1, "2天前"))
    heat1 = str(a.getData(i, 1, "1天前"))
    heat = str(a.getData(i, 1, "0天前"))
    ...
    a.updateHeat('下一天', predicted_heat, i+1)
